...
class Add extends AbstractObserver
{
    ...
    public function __construct(
        ...
        \Pulsestorm\Commercebug\Model\LogFactory $logFactory,
        \Pulsestorm\Commercebug\Model\RenderedData $renderedData,        
        \Magento\Developer\Helper\Data $developerHelper,
        \Pulsestorm\Commercebug\Renderer\JsonFactory $jsonFactory,
    ...
    protected function getCommerceBugData($observer)
    {
        ...
        $cb_data = \Pulsestorm\Commercebug\Model\All::asData();
